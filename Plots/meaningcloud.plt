...
# set title "Emotions in description per User Group \n with respect to Emotion Wheel (Fraction)" offset 7 font "Helvetica,30" 
...
set out "emotions.eps"
NO_ANIMATION = 1

plot 'emotions.dat' using (100.*$2/$10):xtic(1) t column(2) lt rgb '#e30b00', '' using (100.*column(3)/column(10)) title column(3) lt rgb '#ff6d19', \
